...
Board settings
==============
The example is configured to use UART0 with PTB16 and PTB17 pins.
...
The example use PTC9 as card detection pin. In order to make the card detection pin work, the
